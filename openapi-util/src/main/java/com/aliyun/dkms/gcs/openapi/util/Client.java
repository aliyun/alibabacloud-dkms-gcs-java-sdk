...
public class Client {
    ...
    public final static String SDK_VERSKION = "0.5.3";
    ...
    public static String getUserAgent(String userAgent) {
        ...
        if (userAgent != null) {
            return String.format("AlibabaCloud (%s; %s) Java/%s %s %s/%s", sysProps.getProperty("os.name"), sysProps
                    .getProperty("os.arch"), sysProps.getProperty("java.runtime.version"), userAgent, SDK_NAME, SDK_VERSKION);
        }
        return String.format("AlibabaCloud (%s; %s) Java/%s %s/%s", sysProps.getProperty("os.name"), sysProps
                .getProperty("os.arch"), sysProps.getProperty("java.runtime.version"), SDK_NAME, SDK_VERSKION);
    }
